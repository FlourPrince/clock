...
public class GitlabUrlConstants {
    ...
    private static  String COMPARE_BRANCHES_COMMIT_DETAIL_URL="%s/api/v4/projects/%s/repository/compare?from=%s&to=%s&private_token=%s";
     ...
     * @return
     */
    public static String getProjectUrl(String url, String token, String page) {
        String s = String.format(PROJECT_URL, url, token, page);
        return s;
    }
    ...
    public static  String getCompareBranchesCommitDetail(String url, String projectId,String from,String to, String token){
        String s = String.format(COMPARE_BRANCHES_COMMIT_DETAIL_URL, url, projectId, from,to,token);
        return s;
    }
